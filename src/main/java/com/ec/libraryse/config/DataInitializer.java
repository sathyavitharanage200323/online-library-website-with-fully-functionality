package com.ec.libraryse.config;

import com.ec.libraryse.model.Book;
import com.ec.libraryse.model.Staff;
import com.ec.libraryse.repository.BookRepository;
import com.ec.libraryse.repository.StaffRepository;
...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeStaff() {
        ...
        staff1.setPhoneNumber("+1-555-0101");
        ...
        staff2.setPhoneNumber("+1-555-0102");
        ...
        staff3.setPhoneNumber("+1-555-0103");
        ...
        staff4.setPhoneNumber("+1-555-0104");
        ...
        staff5.setPhoneNumber("+1-555-0105");
